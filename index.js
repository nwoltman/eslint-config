...
/* eslint max-len: ["error", { "code": 100, "ignoreTrailingComments": true }] */
...
module.exports = {
  ...
  rules: {
    'array-bracket-newline': [2, 'consistent'], // Would prefer {"multiline": true}, but it is too harsh in disallowing newlines
    ...
    'no-with': 2,
    'object-curly-newline': [2, {consistent: true}], // Would prefer "multiline", but it doesn't allow 1 property
